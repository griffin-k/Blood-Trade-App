package com.blood.trade.adapters;
...
import com.blood.trade.StringCaseConverter;
import com.blood.trade.listeners.MyOnClickListener;
...
public class adminadapter extends RecyclerView.Adapter<adminadapter.UserHolder>{
    ...
    public adminadapter(Context context,ArrayList<User> users, MyOnClickListener onClickListenerCall,MyOnClickListener onClickListenerShare){
...
//        this.myOnClickListenerCall = onClickListenerCall;
    ...
    public UserHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new UserHolder(LayoutInflater.from(context).inflate(R.layout.admindetail,parent,false));
    }
