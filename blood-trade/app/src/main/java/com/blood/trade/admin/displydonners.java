...
import com.blood.trade.adapters.adminadapter;
...
public class displydonners extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_displydonners);
    ...
    void initializeComponents() {
        ...
        users = new ArrayList<>();
        temp = new ArrayList<>();
        adapter = new adminadapter(this, users, position -> {
        ...
        FirebaseDatabase.getInstance().getReference("Donors").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot ds : snapshot.getChildren()) {
                    ...
                    if(user != null && user.getStep() != null && user.getVisible() != null && user.getDonnerGroup() != null) {
                        if(user.getStep().equals("Done") && user.getVisible().equals("True") && user.getDonnerGroup().equals("Donner")) {
                            users.add(user);
                            temp.add(user);
                        }
                        if(user.getUID() != null && user.getUID().equals(uid)) {
                            self = user;
                            MenuItem visibleDonorsItem = popupMenu.getMenu().findItem(R.id.visibleDonors);
                            if(visibleDonorsItem != null) {
                                visibleDonorsItem.setChecked("True".equals(self.getVisible()));
                            }
                        }
                    }
                }
    ...
    public void viewRequestList(View view) {
        startActivity(new Intent(displydonners.this,displayaccepter.class));
        this.finish();
    }
