...
import com.blood.trade.adapters.UserAdapter;
...
public class displayaccepter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_displayaccepter);
    ...
    private void initializeComponents() {
        ...
        requests = new ArrayList<>();
        adapter = new adminadapter(this, requests, position -> {
            //call button handle
        ...
        list.setLayoutManager(new LinearLayoutManager(displayaccepter.this));
    ...
    public void viewDonorsList(View view) {
        startActivity(new Intent(displayaccepter.this,displydonners.class));
        this.finish();
    }
        ...
        FirebaseDatabase.getInstance().getReference("Donors").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot ds : snapshot.getChildren()){
                    ...
                    if(user != null && "Done".equals(user.getStep())) {
                        String requestBlood = user.getRequestBlood();
                        if ("True".equals(requestBlood)) {
                            requests.add(user);
                            temp.add(user);
                        }
                        if (uid.equals(user.getUID())) {
                            self = user;
                            requestCancelBtn.setText("True".equals(self.getRequestBlood()) ? "Cancel Blood Request" : "Request Blood");
                        }
                    }
                }
